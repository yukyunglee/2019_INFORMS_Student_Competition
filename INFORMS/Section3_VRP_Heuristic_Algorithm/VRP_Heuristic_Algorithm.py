...
#             print('dealer_vin_dic',dealer_vin_dic)
#             print('vin_dealer_dic',vin_dealer_dic)
            period_df
            av_route={}
                ...
                for idx, value in enumerate(distance):
                    if value == max(distance):
                        ...
                        if len(distance)>2 and k==0:
                            ...
                            for j in dealer[1:]:
                                len_deal=len(dealer_vin_dic[j])
                                mod_d = 10*(len_deal//10)-1
                                if len_deal >10:
                            ...
                            for idx_, value_ in enumerate(av_distance):
                                if value_ == min(av_distance):
                                    ...
                                    if max_deal != vdc and av_min_deal != vdc and len(av_distance)>2 and q==0:
                                        ...
                                        len_max_deal=len(dealer_vin_dic[max_deal])
                                        mod_lm = 10*(len_max_deal//10)-1
                                       
                                        if len_max_deal>10:
                                            for k in range(len_max_deal):
                                                if k>mod_lm:
...
#     location = pd.read_excel('C:/Users/yukyunglee/OneDrive - 한국외국어대학교/VRP_test/Input_Cost%2C+Location.xlsx')
#     dist = pickle.load(open('C:/Users/yukyunglee/OneDrive - 한국외국어대학교/VRP_test/dist_mat_9361.dump', 'rb'))
#     ind = pickle.load(open('C:/Users/yukyunglee/OneDrive - 한국외국어대학교/VRP_test/location_index_9361.dump', 'rb'))
...
#     vlist = location[location['Dealer?']==0]['Location']

#     vdc_list =[]
#     for i in vlist:
#         vdc_list.append(i)
#     master = pickle.load(open('C:/Users/yukyunglee/OneDrive - 한국외국어대학교/VRP_test/error_3F_20130318_s4.dump', 'rb'))
# #     master = pickle.load(open('/Users/YukyungLee/한국외국어대학교/강문정 - informs/master_dir/s4-2015_2016/2017-02-01.dump', 'rb'))
...
#     #print('cars_to_deliver_df',len(cars_to_deliver_df))
#     AV_dist=300
    
#     print('start processing...')
#     sss = time.time()
    
#     cost, solution, adjusted_solution,solution_delta,ten_solution_delta = vrp.solve_vrp(vdc, day, cars_to_deliver_df, period,AV_dist, AV=True, log=False,time_out=10)
    
#     all_vins = [
#        vin
#        for sh in adjusted_solution
#        for vin,_,_ in adjusted_solution[sh]['vins']
#    ]
#     print("running time: ",time.time()-sss)
    
    
#     print(len(all_vins), len(set(all_vins)))

#     from collections import Counter

#     print(Counter(all_vins))
